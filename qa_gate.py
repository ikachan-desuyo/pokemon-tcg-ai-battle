...
BLOCKING_PREFIXES = [
    ...
    "BenchBaitLoss",
    "BaseLineSacrifice",
    "EvolveIntoLoss",                             # activeへの進化が負けベイト化(人間レビュー13巡目)                          # 進化土台を確定死圏に前進(進化先在手)(人間レビュー12巡目)                              # ボス釣りベイト放置(回復で圏外化可能)(人間レビュー11巡目)                             # 死んだら負けのactive放置(退避可)(自己レビューarch-7)                             # 未充足コストを進めないエネ選択(10巡目: R+P二色でR重ね)                            # 展開前に進化トリガー消費(9巡目)                                        # 単騎でたね在手なのに未展開(8巡目)                                           # 耐える壁を退き脆いたねを前進(人間レビュー7巡目)
]
